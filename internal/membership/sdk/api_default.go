...
type DefaultAPI interface {
	...
	*/
	...
	/*
	GetRegions get regions using filters
	...
	*/
	...
	GetRegionsExecute(r ApiGetRegionsRequest) (*ListRegionsResponse, *http.Response, error)
...
func (r ApiGetRegionsRequest) Execute() (*ListRegionsResponse, *http.Response, error) {
...
GetRegions get regions using filters
 ...
 @return ApiGetRegionsRequest
*/
func (a *DefaultAPIService) GetRegions(ctx context.Context) ApiGetRegionsRequest {
	return ApiGetRegionsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return ListRegionsResponse
func (a *DefaultAPIService) GetRegionsExecute(r ApiGetRegionsRequest) (*ListRegionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetRegions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
