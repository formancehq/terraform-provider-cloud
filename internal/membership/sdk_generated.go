...
//
//	mockgen -source=./sdk/api_default.go -destination=sdk_generated.go -package=membership . DefaultAPI
//
...
import (
	...
	sdk "github.com/formancehq/terraform-provider/sdk"
...
func (m *MockDefaultAPI) GetRegions(ctx context.Context) sdk.ApiGetRegionsRequest {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRegions", ctx)
	ret0, _ := ret[0].(sdk.ApiGetRegionsRequest)
	return ret0
}

// GetRegions indicates an expected call of GetRegions.
func (mr *MockDefaultAPIMockRecorder) GetRegions(ctx any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRegions", reflect.TypeOf((*MockDefaultAPI)(nil).GetRegions), ctx)
}

// GetRegionsExecute mocks base method.
func (m *MockDefaultAPI) GetRegionsExecute(r sdk.ApiGetRegionsRequest) (*sdk.ListRegionsResponse, *http.Response, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRegionsExecute", r)
...
// GetRegionsExecute indicates an expected call of GetRegionsExecute.
func (mr *MockDefaultAPIMockRecorder) GetRegionsExecute(r any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetRegionsExecute", reflect.TypeOf((*MockDefaultAPI)(nil).GetRegionsExecute), r)
}
